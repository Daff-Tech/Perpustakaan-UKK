...
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Judul</label>
    <input type="text" name="judul" value="{{ $buku->judul }}" class="form-control">   
</div>
<div class="form-group">
    <label class="text-light font-weight-bold" for="">ISBN</label>
    <input type="text" name="isbn" value="{{ $buku->isbn }}" class="form-control">   
</div>
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Penulis</label>
    <input type="text" name="penulis" value="{{ $buku->penulis }}" class="form-control">   
</div>
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Penerbit</label>
    <input type="text" name="penerbit" value="{{ $buku->penerbit }}" class="form-control">   
</div>
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Tahun</label>
    <input type="number" name="tahun_terbit" value="{{ $buku->tahun_terbit }}" class="form-control">   
</div>
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Lokasi</label>
...
<div class="form-group">
    <label class="text-light font-weight-bold" for="">Stok</label>
...
<div class="float-right">
    ...
    <button type="submit" class="btn btn-primary border border-{#ffffff}">update</button>
</div>
</form>
