...
<head>
            ...
            <div class="scrollbar-inner">
                ...
                <div class="sidenav-header  align-items-center">
                    <a class="navbar-brand" href="javascript:void(0)">
                        <img src="{{ asset('logoperpus.png') }}" class="navbar-brand-img" alt="...">
                    </a>
                </div>
    ...
    <div class="main-content"
        id="panel">
    <!-- Topnav -->
    <nav class="navbar navbar-top navbar-expand navbar-dark border-bottom" style="background-color:#131313">
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown"
                                ...
                                <div class="media align-items-center">
                                    <span class="avatar avatar-sm rounded-circle">
                                        <img alt="Image placeholder" src="{{ asset('profile.png') }}">
                                    </span>
    ...
    <!-- Header -->
    <!-- Header -->
    <div class="header  pb-6" style="background-color:#131313">
        <div class="container-fluid">
